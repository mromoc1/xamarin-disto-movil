...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("disto_movil.Platforms.SpeechRecognitionListener, disto-movil", SpeechRecognitionListener.class, __md_methods);
	}
	...
	public SpeechRecognitionListener ()
	{
		...
		if (getClass () == SpeechRecognitionListener.class)
			mono.android.TypeManager.Activate ("disto_movil.Platforms.SpeechRecognitionListener, disto-movil", "", this, new java.lang.Object[] {  });
	}
